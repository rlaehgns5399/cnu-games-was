...
public class BoardController {
    ...
    @CnuLogin
    @ApiImplicitParam(name = "token", value = "Facebook client access token", required = false, dataType = "string", paramType = "header", defaultValue = "")
    @RequestMapping(value = "", method = RequestMethod.GET)
    public Page<Board> findBoardList(@RequestParam int page, @RequestParam(defaultValue = "10") int size, Pageable pageable) {
